...
const Home = () => {
  ...
  useEffect(() => {
    ...
    onSnapshot(q, (QuerySnapshot) => {
      setStudents(QuerySnapshot.docs.map(doc => ({ ...doc.data(), id: doc.id, sid: doc.data().sid, firstname: doc.data().firstname, lastname: doc.data().lastname, time: doc.data().time.tos })))
    });
  }, [])
