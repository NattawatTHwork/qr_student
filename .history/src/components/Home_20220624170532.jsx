            ...
            <table className="border-collapse border-2">
              ...
              <tbody>
                {students.map((student) => (
                  <tr key={student.id}>
                    <th scope='row' className='border ml-2 mt-2 mr-2 mb-2'><p className='ml-2 mt-2 mr-2 mb-2'>{count=count+1}</p></th>
                    <td className='border-2'><p className='ml-2 mt-2 mr-2 mb-2'>{rule.rule}</p></td>
                  </tr>
                ))}
              </tbody>
            </table>
