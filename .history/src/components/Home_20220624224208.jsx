...
import { collection , query , onSnapshot , orderBy , toDate} from 'firebase/firestore'
              ...
              <tbody>
                {students.map((student) => (
                  <tr key={student.id}>
                    ...
                    <td className='border-2'><p className='ml-2 mt-2 mr-2 mb-2'>{student.time.toDateingStr()}</p></td>
                  </tr>
                ))}
              </tbody>
            </table>
