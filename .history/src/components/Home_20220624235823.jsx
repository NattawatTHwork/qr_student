...
import { collection , query , onSnapshot , orderBy , startAfter } from 'firebase/firestore'
...
const Home = () => {
  ...
  useEffect(() => {
    const q = query(collection(db, "list"), orderBy('time', 'desc'), startAfter(lastVisible));
