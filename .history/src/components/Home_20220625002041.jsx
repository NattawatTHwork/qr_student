        ...
        <div className='flex'>
          <div className='flex mx-auto'>
            <table className="border-collapse border-2">
              <thead>
                <tr>
                  <th scope='col' className='border-2 px-20'><p className='ml-2 mt-2 mr-2 mb-2'>Student ID</p></th>
                  <th scope='col' className='border-2 px-20'><p className='ml-2 mt-2 mr-2 mb-2'>ชื่อ-สกุล</p></th>
