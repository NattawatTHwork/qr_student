...
const Home = () => {
  ...
  useEffect(() => {
    ...
    onSnapshot(q, (QuerySnapshot) => {
      ...
      if (student != students) {
        const laststudent = student.docs.map(doc => ({ id: doc[0].id, sid: doc[0].data().sid, firstname: doc[0].data().firstname, lastname: doc[0].data().lastname, time: doc[0].data().time }))
