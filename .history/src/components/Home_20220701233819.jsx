...
const Home = () => {
  ...
  useEffect(() => {
    ...
    onSnapshot(q, (QuerySnapshot) => {
      ...
      if (student != students) {
        const laststudent = { id: student[0].id, sid: student[0].sid, firstname: student[0].firstname, lastname: student[0].lastname, time: student[0].time }
            ...
            <div className="relative w-auto my-6 mx-auto max-w-sm">
              ...
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                ...
                <div className="relative p-6 flex-auto">
                  ...
                  <h3>Name : {laststudent.firstname} {laststudent.lastname}</h3>
                  <h3>Time : {convertTime(laststudent.time)}</h3>
