    ...
    onSnapshot(q, (QuerySnapshot) => {
      ...
      if (student != students) {
        ...
        onSnapshot(qq, (QuerySnapshot) => {
          QuerySnapshot.docs.map(doc => ({ ...doc.data(), id: doc.id, sid: doc.data().sid, firstname: doc.data().firstname, lastname: doc.data().lastname, time: doc.data().time }))

          const pathReference = ref(storage, `images/${student.sid}.jpg`);
