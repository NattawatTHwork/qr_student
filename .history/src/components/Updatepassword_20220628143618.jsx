    ...
    <div className='max-w-[700px] mx-auto my-16 p-4'>
      ...
      <form onSubmit={handleSubmit}>
        <div className='flex flex-col py-2'>
          ...
          <input onChange={(e) => setPassword(e.target.value)} className='border p-3 rounded' type='email' />
        </div>
        <div className='flex flex-col py-2'>
          <label className='py-2 font-medium'>Repeat New Password</label>
          <input onChange={(e) => set(e.target.value)} className='border p-3 rounded' type='password' />
        </div>
